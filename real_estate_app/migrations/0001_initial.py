# Generated by Django 4.0 on 2024-09-23 09:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PrimaryNumber', models.CharField(max_length=20)),
                ('SecondaryNumber', models.CharField(max_length=20)),
                ('Image', models.ImageField(upload_to='images/residential/residential_records')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PrimaryNumber', models.CharField(max_length=20)),
                ('SecondaryNumber', models.CharField(max_length=20)),
                ('Image', models.ImageField(upload_to='images/residential/residential_rent')),
                ('Created_at', models.DateTimeField(default=django.utils.timezone.now)),
            ],
            options={
